package com.labelwall.mywall.ui.animation;
...
import com.labelwall.mywall.ui.dimen.ScreenUtils;

public final class BezierAnimation {

    public static void addCart(WallDelegate delegate, View start, View end,
