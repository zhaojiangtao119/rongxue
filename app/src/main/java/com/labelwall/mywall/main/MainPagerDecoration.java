...
public class MainPagerDecoration extends RecyclerView.ItemDecoration {

    private Paint mPaint;
    private int mDividerWidth;

    public MainPagerDecoration(int height, @ColorInt int color) {
    ...
    public void getItemOffsets(Rect outRect, View view, RecyclerView parent, RecyclerView.State state) {
        ...
        int spanCount = getSpanCount(parent);//返回列数
        int childCount = parent.getAdapter().getItemCount();//item的个数
