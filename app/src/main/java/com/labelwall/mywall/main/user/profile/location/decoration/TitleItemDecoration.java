package com.labelwall.mywall.main.user.profile.location.decoration;
...
import com.labelwall.mywall.main.user.profile.location.ProvinceBean;
import com.labelwall.mywall.main.user.profile.location.bean.BaseIndexTagBean;
...
public class TitleItemDecoration extends RecyclerView.ItemDecoration {
    ...
    public TitleItemDecoration(Context context, List<ProvinceBean> datas) {
        super();
        mDatas = datas;
        mPaint = new Paint();
        mBounds = new Rect();
